...
hardware, batch_size, num_epochs, best_criterion, num_train, num_valid = \
		args.hardware, args.batch_size, args.num_epochs, args.best_criterion, args.num_train, args.num_valid
...
fig.savefig(os.path.join(plots_path, '%d_%d_%d_accuracy_loss.png' % (num_epochs, num_train, num_valid)))
